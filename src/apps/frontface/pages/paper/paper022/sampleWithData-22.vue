  ...
  <main>
    <PaperDoc>
      ...
      <div class="flex flex-col mt-1">
        <p>เรียน คณะกรรมการดำเนินการสหกรณ์ออมทรัพย์ โรงพยาบาลศรีสะเกษ จำกัด</p>
      </div>

      <div class="flex flex-col ml-10">
        <p>
          ข้าพเจ้า {{ data?.Fname }} {{ data?.Lname }} สมาชิกเลขทะเบียนที่ {{ data?.IDMember }}
        </p>
      </div>
      ...
      <div class="flex flex-col ml-10">
        <p>ข้อ ๑. ข้าพเจ้าขอกู้เงินของสหกรณ์
          จำนวน {{ data?.borrowmoney }} บาท
          ( {{ data?.writenumber }} )</p>
      </div>

      <div class="flex flex-col ">
        <p>
          โดยจะนำไปใช้เพื่อการดังนี้ {{ data?.apply }}
        </p>
      </div>
      ...
      <div class="flex flex-col ml-10">
        <p class="text-end">(๑)
          ภายในวันสิ้นเดือน {{ formatDate(data?.dateReceived) }} ต้นเงิน {{ data?.interest }} บาท
          พร้อมด้วยดอกเบี้ย
        </p>
        <p class="text-end">(๒)
          ภายในวันสิ้นเดือน {{ formatDate(data?.dateReceived) }} ต้นเงิน {{ data?.interest }} บาท
      ...
      <div class="mb-3 text-right ">
        <div class=" ml-10 mt-1">
           {{ data.Fname }} {{ data.Fname }} ผู้ขอกู้ 
        </div>
        <div class=" mr-10 ">
          ( {{ data.Fname }} {{ data.Fname }} )
        </div>
        <div class=" ml-10 ">
          {{ data.Fwitness1 }} {{ data.Lwitness1 }} พยาน
        </div>
        <div class=" mr-10">
          ( {{ data.Fwitness1 }} {{ data.Lwitness1 }} )
        </div>
        <div class=" ml-10">
          {{ data.Fwitness2 }} {{ data.Lwitness2 }} พยาน
        </div>
        <div class=" mr-10">
          ( {{ data.Fwitness2 }} {{ data.Lwitness2 }} )
        </div>
...
const { data } = await useFetch<any>('/api/sampleWithData-22');
