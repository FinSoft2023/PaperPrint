<template>
    <main>
      <PaperDoc>
        ...
        <div class="flex flex-col mr-6">
            ...
            <p class="text-center">(<FiLL :data="data?.witnessFname" /> <FiLL :data="data?.witnessLname" />)</p>
            <p class="text-center">เกี่ยวข้องเป็น <FiLL :data="data?.relation" /></p>
            <p class="text-center">เบอร์โทร <FiLL :data="data?.phoneNumber" /></p>
  ...
  const { data } = await useFetch<any>('/api/apply10');
